...
public class HistoryListSectionModel extends AbstractItem<HistoryListSectionModel, HistoryListSectionModel.ViewHolder> implements IExpandable<HistoryListSectionModel, IItem> {
    ...
    private FastAdapter.OnClickListener<HistoryListSectionModel> mOnClickListener;

    public HistoryListSectionModel(int setId, Date date, String name, int exerciseId, double volume, int setCount, String measurement, boolean isEmpty, boolean isFirst) {
        this.setId = setId;
        this.name = name;
        this.date = date;
    ...
    @Override
    public HistoryListSectionModel withIsExpanded(boolean expanded) {
        mExpanded = expanded;
        return this;
    }
    ...
    public HistoryListSectionModel withSubItems(List<IItem> subItems) {
        this.mSubItems = subItems;
        return this;
    }

    public FastAdapter.OnClickListener<HistoryListSectionModel> getOnClickListener() {
        return mOnClickListener;
    }

    public HistoryListSectionModel withOnClickListener(FastAdapter.OnClickListener<HistoryListSectionModel> mOnClickListener) {
        this.mOnClickListener = mOnClickListener;
        return this;
    }

    //we define a clickListener in here so we can directly animate
    final private FastAdapter.OnClickListener<HistoryListSectionModel> onClickListener = new FastAdapter.OnClickListener<HistoryListSectionModel>() {
        @Override
        public boolean onClick(View v, IAdapter adapter, HistoryListSectionModel item, int position) {
     ...
     */
    @Override
    public FastAdapter.OnClickListener<HistoryListSectionModel> getOnItemClickListener() {
