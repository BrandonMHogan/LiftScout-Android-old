...
public class TodayListItemModel extends AbstractItem<TodayListItemModel, TodayListItemModel.ViewHolder> implements IDraggable<TodayListItemModel, IItem> {
    ...
    public TodayListItemModel(int setId, int exerciseId, int reps, double weight, String measurement, boolean isRecord, boolean isLastItem) {
        this.setId = setId;
    ...
    public TodayListItemModel(int setId, int exerciseId, boolean isEmpty, String emptyMessage, boolean isLastItem) {
        this.setId = setId;
        this.exerciseId = exerciseId;
    ...
    @Override
    public TodayListItemModel withIsDraggable(boolean draggable) {
