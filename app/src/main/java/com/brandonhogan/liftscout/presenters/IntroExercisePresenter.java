...
public class IntroExercisePresenter implements IntroExerciseContract.Presenter {
    ...
    // Private Properties
    //
    private IntroExerciseContract.View view;

    public IntroExercisePresenter(IntroExerciseContract.View view) {
